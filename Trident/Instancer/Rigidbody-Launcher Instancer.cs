...
namespace VRLabs.RigidbodyLauncher
{
	public class RigidbodyLauncher : ScriptableObject
	{
		public const string packageName = "Rigidbody-Launcher";
		...
		[MenuItem("VRLabs/Create Instance/Rigidbody Launcher")]
